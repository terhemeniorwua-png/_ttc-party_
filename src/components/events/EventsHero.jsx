  ...
  return (
    <section className="relative bg-navy text-white py-20 md:py-24 px-6 overflow-hidden border-b border-white/10">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10 space-y-6">
        ...
        >
          <Calendar className="w-4 h-4 text-green-transform" />
          <span>Community Conventions & Forums</span>
        </motion.div>
        ...
        >
          Gatherings That Drive Real Reform.
        </motion.h1>
        ...
        >
          Connect with policy creators, community advocates, and citizens at our upcoming town halls, summits, and workshops nationwide.
        </motion.p>
      </div>
    </section>
  );
