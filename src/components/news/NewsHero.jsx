  ...
  return (
    <section className="relative bg-navy text-white py-20 md:py-24 px-6 overflow-hidden border-b border-white/10">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10 space-y-6">
        ...
        >
          <Newspaper className="w-4 h-4 text-green-transform" />
        ...
        >
          News, Field Stories & Impact Reports.
        </motion.h1>
        ...
        >
          Stay informed with real-time updates from our constituency outreach, policy deployments, and community programs.
        </motion.p>
      </div>
    </section>
  );
